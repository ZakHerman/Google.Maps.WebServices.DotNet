...
namespace Google.Maps.WebServices.Geocoding
{
    ...
    public class GeocodingRequestOptions : GoogleMapsRequestOptions<GeocodingRequestOptions>
    {
        ...
        public GeocodingRequestOptions SetBounds(LatLng southWestBound, LatLng northEastBound)
        {
            ...
            if (northEastBound is null)
                throw new ArgumentNullException(nameof(northEastBound));
        ...
        {
            if (componentFilters is null)
                throw new ArgumentNullException(nameof(componentFilters));
