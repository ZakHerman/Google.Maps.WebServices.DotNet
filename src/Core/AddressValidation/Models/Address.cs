...
public class Address
{
    ...
    public List<AddressComponent> AddressComponents { get; } = new();
    ...
    public List<string> MissingComponentTypes { get; } = new();
    ...
    public List<AddressComponentType> UnconfirmedComponentTypes { get; } = new();
    ...
    public List<string> UnresolvedTokens { get; } = new();
}
